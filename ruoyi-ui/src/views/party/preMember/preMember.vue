  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="18" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="150px">
          <el-form-item label="入会积极分子姓名" prop="memberName">
            <el-input
              v-model="queryParams.memberName"
              placeholder="请输入入会积极分子姓名"
              clearable
              size="small"
        ...
        <el-table :stripe="true"
          ...
          <el-table-column label="成为入会积极分子日期" align="center" prop="preMemberData" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="90%" append-to-body
      ...
      <el-form ref="form" :model="form" :rules="rules" :style="bodyStyle" label-width="150px">
        ...
        <el-card shadow="always" style="margin-bottom: 30px;">
          <div slot="header" style="height: 25px">
            <span style="font-weight: bold;font-size: 16px">入会积极分子信息</span>
          </div>
          <el-row>
            <el-col :span="8">
      ...
      <div slot="footer" class="dialog-footer" :style="{textAlign:'center'}">
        <el-button v-if="!disabled && form.memberId !=undefined " type="primary" @click="chooseAuditUser">转为预备会员</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleExport() {
        let that = this;
        this.$confirm('是否确认导出所选工会所有入会积极分子信息数据项?', "警告", {
