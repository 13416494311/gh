        ...
        <el-card shadow="always" style="margin-bottom: 30px;">
          ...
          <el-form ref="form" :model="form" :rules="rules" :style="bodyStyle" label-width="100px">
            ...
            <el-form-item label="评审人" prop="assessorName">
              <el-input :disabled="true" v-model="memberName" placeholder="请选择会员">
                <el-button :disabled="disabled" slot="append" icon="el-icon-search"
                           @click="openMemberChoose"></el-button>
              </el-input>
            </el-form-item>
            <el-form-item label="评审人工会" prop="partyOrgId">
            ...
            <el-form-item label="评价内容一：" prop="">
              履行党建工作责任情况。基层工会书记履行抓党建第一责任人职责、推动工作落实、牵头组织实施抓党建工作，调动班子其他成员履行基层党建责任等情况。
            </el-form-item>
            ...
            <el-form-item label="评价内容二：" prop="">
              提高基层工会建设质量情况。落实“三会一课”等基本制度，发展会员和会员教育管理、主题党日等情况；统筹推进基层工会建设情况。
            </el-form-item>
            ...
            <el-form-item label="评价内容三：" prop="">
              强化政治功能，完成重大任务情况。发挥基层工会战斗堡垒作用和会员先锋模范作用，总结推广基层党建工作典型经验；推进创新性工作，研究新情况、解决新问题，探索加强基层党建工作情况。
            </el-form-item>
            ...
            <el-form-item label="评价内容四：" prop="">
              解决突出问题、破解重点难题情况。深入查摆分析基层工会书记在履行抓基层党建工作责任中存在的差距和不足、基层党建工作中存在的突出问题和薄弱环节。
            </el-form-item>
...
<!--            <el-table-column type="selection" width="55" align="center"/>-->
            ...
            <el-table-column label="评审人工会" align="center" prop="djPartyOrg.partyOrgName"/>
